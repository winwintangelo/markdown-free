...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Markdown Free — Convert Markdown to PDF, Word (DOCX), Image (PNG), EPUB" }], title: "2026 के लिए सबसे अच्छा Markdown से PDF कन्वर्टर", description: "8 Markdown→PDF टूल्स की ईमानदार तुलना, हर उपयोग के लिए कौन जीतता है।", locale: "hi_IN" },
  };
}
...
const faq = [
  ...
  { q: "संवेदनशील दस्तावेज़ों के लिए कौन सा Markdown कन्वर्टर सबसे सुरक्षित है?", a: "कोई भी जो स्थानीय रूप से चलता है — Pandoc, Typora, Markdown PDF (VS Code), md-to-pdf — आपकी फ़ाइलें आपकी मशीन पर रखता है। ब्राउज़र टूल्स में, Markdown Free HTML, TXT, इमेज, EPUB और Excel निर्यात पूरी तरह ब्राउज़र में करता है, और PDF व Word फ़ाइलों को सर्वरलेस मेमोरी में बिना स्टोर किए प्रोसेस करता है। जो टूल सर्वर पर अपलोड करते हैं (Online2PDF) उनमें सबसे अधिक गोपनीयता जोखिम है।" },
  { q: "क्या Markdown Free पर फ़ाइल आकार की सीमा है?", a: "हाँ — वर्तमान में 1MB प्रति फ़ाइल। 1MB Markdown लगभग 150,000 शब्दों के बराबर है, जो लगभग सभी वास्तविक दस्तावेज़ों को कवर करता है। बड़ी फ़ाइलों के लिए, कमांड लाइन से Pandoc की कोई बिल्ट-इन आकार सीमा नहीं है।" },
];
        ...
        <article className="prose prose-slate max-w-none">
          ...
          <div className="not-prose my-6 overflow-x-auto"><table className="w-full border-collapse text-sm">
            ...
            <tbody className="text-slate-700">
              <tr className="border-b border-slate-100"><td className="px-3 py-3 font-medium">Markdown Free</td><td className="px-3 py-3">ब्राउज़र, गैर-लैटिन लिपियाँ</td><td className="px-3 py-3">मुफ्त</td><td className="px-3 py-3">हाँ — Noto फ़ॉन्ट एम्बेडेड, कोई सेटअप नहीं</td><td className="px-3 py-3">PDF, DOCX, PNG, EPUB, HTML, TXT</td><td className="px-3 py-3">कोई नहीं</td><td className="px-3 py-3">मेमोरी में फ़ाइलें, कोई स्टोरेज नहीं</td></tr>
          ...
          <h2>Markdown Free</h2>
          <p>एक ब्राउज़र-आधारित Markdown कन्वर्टर: HTML, TXT, इमेज (PNG/JPG), EPUB और Excel निर्यात पूरी तरह ब्राउज़र में चलते हैं, जबकि PDF और Word (DOCX) सर्वरलेस इंफ्रास्ट्रक्चर पर बनते हैं, जहाँ फ़ाइलें मेमोरी में प्रोसेस होकर तुरंत हटा दी जाती हैं। इस सिद्धांत पर बना है कि पंजीकरण, विज्ञापन या ट्रैकर जोड़ने से 30 सेकंड का काम कष्टप्रद हो जाता है।</p>
          ...
          <p><strong>फायदे:</strong> कोई पंजीकरण नहीं, कोई ट्रैकिंग कुकीज़ नहीं, गोपनीयता-अनुकूल विश्लेषण, 10-भाषा UI, AI-जेनरेटेड Markdown को कॉर्पोरेट Word दस्तावेज़ों में बदलने के लिए मजबूत DOCX आउटपुट, हर फ़ॉर्मेट में LaTeX सूत्र और Mermaid डायग्राम रेंडर होते हैं।<br /><strong>नुकसान:</strong> 1MB प्रति फ़ाइल सीमा, कोई ऑफ़लाइन मोड नहीं (ब्राउज़र की आवश्यकता है), कोई बैच नहीं (एक बार में एक फ़ाइल), PDF स्टाइल कस्टमाइज़ नहीं हो सकती, Word में सूत्र अभी संपादित नहीं हो सकते।<br /><strong>किसके लिए:</strong> कोई भी जिसे अभी Markdown को PDF, DOCX या EPUB में बदलने की आवश्यकता है, बिना इंस्टॉलेशन के, विशेष रूप से गैर-लैटिन लिपियों के लिए।</p>
