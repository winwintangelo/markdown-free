...
export async function generateMetadata({
  ...
  return {
    title: "Markdown轉EPUB電子書 – 免費線上轉換工具 | Markdown Free",
    description:
      "免費將Markdown轉換為EPUB電子書。線上markdown轉epub，無需註冊、無限制。適合在Kindle、Apple Books、Kobo等電子閱讀器上閱讀。",
    keywords: [
      "markdown轉epub",
      "線上markdown轉epub",
      "markdown轉epub線上",
...
const faqJsonLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "這個Markdown轉EPUB工具是免費的嗎？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "是的！Markdown Free 100%免費，沒有隱藏費用、進階方案或註冊要求。"
      }
    },
    {
      "@type": "Question",
      "name": "EPUB能在Kindle上使用嗎？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "可以。現代Kindle裝置原生支援EPUB。對於舊款機型，你可以使用“傳送到Kindle”功能或Calibre將EPUB轉換為MOBI。"
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Markdown Free會在H1標題處（如果沒有H1則在H2處）自動將文件分割成章節，並生成可導覽的目錄。"
      }
    },
    {
      "@type": "Question",
      "name": "我的檔案會儲存在你們的伺服器上嗎？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "不會。你的檔案在記憶體中處理，轉換後立即刪除。我們從不儲存你的內容。"
      }
    }
  ]
};
