...
const faq = [
  ...
  },
  {
    ...
    a: "ローカルで動作するもの（Pandoc、Typora、Markdown PDF (VS Code)、md-to-pdf）はファイルが手元から離れません。ブラウザツールの中ではMarkdown FreeはHTML・TXT・画像・EPUB・Excelの出力を完全にブラウザ内で処理し、PDFとWordはサーバーレスのメモリ上で生成して保存せずすぐに破棄します。Online2PDFのようにサーバーへアップロードするツールはプライバシー上のリスクが最も高くなります。",
  },
  {
    q: "Markdown Freeにファイルサイズ制限はありますか？",
    a: "はい、現在は1ファイル1MBです。1MBのMarkdownはおおよそ15万語に相当し、実用上のドキュメントはほぼすべてカバーします。それより大きなファイルが必要な場合、コマンドラインのPandocに組み込みのサイズ制限はありません。",
  },
];
    ...
    <ConverterProvider>
      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-8 px-4 pb-16 pt-10">
        <article className="prose prose-slate max-w-none">
          ...
          <div className="not-prose my-6 overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-slate-700">
                <tr className="border-b border-slate-100"><td className="px-3 py-3 font-medium">Markdown Free</td><td className="px-3 py-3">ブラウザ・日本語そのまま</td><td className="px-3 py-3">無料</td><td className="px-3 py-3">完全対応・Notoフォント埋込み・設定不要</td><td className="px-3 py-3">PDF, DOCX, PNG, EPUB, HTML, TXT</td><td className="px-3 py-3">不要</td><td className="px-3 py-3">ファイルは保存せずメモリ処理</td></tr>
          ...
          <h2>Markdown Free</h2>
          <p>HTML・TXT・画像（PNG/JPG）・EPUB・Excelの出力は完全にブラウザ内、PDFとWord（DOCX）はサーバーレスのメモリ上で生成し処理後すぐに破棄するブラウザ型コンバーター。「30秒で終わる作業に登録や広告を挟まない」という方針で開発されています。</p>
