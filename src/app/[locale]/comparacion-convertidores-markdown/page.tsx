...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Markdown Free — Convert Markdown to PDF, Word (DOCX), Image (PNG), EPUB" }], title: "Mejores convertidores Markdown a PDF 2026", description: "Comparación honesta de 8 herramientas Markdown→PDF, con la mejor para cada caso de uso.", locale: "es_ES" },
  };
}
...
const faq = [
  ...
  { q: "¿Qué convertidor es más seguro para documentos sensibles?", a: "Cualquier herramienta local (Pandoc, Typora, Markdown PDF para VS Code, md-to-pdf) mantiene el archivo en tu máquina. Entre las web, Markdown Free procesa las exportaciones HTML, TXT, imagen, EPUB y Excel por completo en el navegador, y los PDF y documentos Word en memoria serverless sin almacenarlos. Las herramientas que suben al servidor (Online2PDF) tienen el mayor riesgo de privacidad." },
  { q: "¿Markdown Free tiene un límite de tamaño de archivo?", a: "Sí, actualmente 1MB por archivo. 1MB de Markdown equivalen aproximadamente a 150.000 palabras, lo que cubre prácticamente cualquier documento real. Para archivos mayores, Pandoc por línea de comandos no tiene límite de tamaño integrado." },
];
    ...
    <ConverterProvider>
      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-8 px-4 pb-16 pt-10">
        <article className="prose prose-slate max-w-none">
          ...
          <h2>Markdown Free</h2>
          <p>Convertidor Markdown basado en navegador: las exportaciones HTML, TXT, imagen (PNG/JPG), EPUB y Excel se procesan por completo en el navegador, mientras que PDF y Word (DOCX) se generan en infraestructura serverless con archivos en memoria, descartados de inmediato. Construido sobre el principio de que añadir registro, anuncios o trackers arruina una tarea de 30 segundos.</p>
          ...
          <p><strong>Fortalezas:</strong> sin registro, sin cookies de tracking, analytics respetuoso con la privacidad, UI en 10 idiomas, salida DOCX sólida para convertir Markdown generado por IA en documentos Word corporativos, fórmulas LaTeX y diagramas Mermaid renderizados en todos los formatos.<br /><strong>Debilidades:</strong> límite de 1MB por archivo, sin modo offline (requiere navegador), sin procesamiento por lotes (un archivo a la vez), sin estilo PDF personalizable, las fórmulas en Word aún no son editables.<br /><strong>Ideal para:</strong> quien necesita convertir Markdown a PDF, DOCX o EPUB ahora mismo sin instalar nada, especialmente con scripts no latinos.</p>
