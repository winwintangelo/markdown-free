...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: "/es/comparacion-convertidores-markdown" },
        ...
        <article className="prose prose-slate max-w-none">
          ...
          <div className="not-prose my-6 overflow-x-auto"><table className="w-full border-collapse text-sm">
            ...
            <tbody className="text-slate-700">
              <tr className="border-b border-slate-100"><td className="px-3 py-3 font-medium">Markdown Free</td><td className="px-3 py-3">Navegador, scripts no latinos</td><td className="px-3 py-3">Gratis</td><td className="px-3 py-3">Sí — fuentes Noto incrustadas, sin configuración</td><td className="px-3 py-3">PDF, DOCX, EPUB, HTML, TXT</td><td className="px-3 py-3">Ninguna</td><td className="px-3 py-3">Archivos en memoria, sin almacenamiento</td></tr>
