...
const faq = [
  ...
  { q: "Bisakah saya mengonversi README.md ke PDF tanpa mendaftar?", a: "Bisa. Markdown Free tidak memerlukan akun. File diproses di browser (HTML/TXT/EPUB) atau di memori serverless (PDF/DOCX) dan tidak pernah disimpan." },
