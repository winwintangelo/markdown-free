...
const faq = [
  ...
  { q: "Quale convertitore Markdown è più sicuro per documenti riservati?", a: "Tutto ciò che gira in locale (Pandoc, Typora, Markdown PDF per VS Code, md-to-pdf) tiene il file sulla tua macchina. Tra gli strumenti browser, Markdown Free elabora gli export HTML, TXT, immagine, EPUB ed Excel interamente nel browser, e PDF e documenti Word in memoria serverless senza archiviarli. Strumenti che caricano sul server (Online2PDF) hanno il rischio di privacy più alto." },
  { q: "Markdown Free ha un limite di dimensione del file?", a: "Sì, attualmente 1MB per file. Un Markdown da 1MB equivale a circa 150.000 parole, copre praticamente ogni documento reale. Per file più grandi, Pandoc da riga di comando non ha limiti integrati di dimensione." },
];
        ...
        <article className="prose prose-slate max-w-none">
          ...
          <div className="not-prose my-6 overflow-x-auto"><table className="w-full border-collapse text-sm">
            ...
            <tbody className="text-slate-700">
              <tr className="border-b border-slate-100"><td className="px-3 py-3 font-medium">Markdown Free</td><td className="px-3 py-3">Browser, script non latini</td><td className="px-3 py-3">Gratuito</td><td className="px-3 py-3">Sì — font Noto incorporati, nessuna config</td><td className="px-3 py-3">PDF, DOCX, PNG, EPUB, HTML, TXT</td><td className="px-3 py-3">Nessuna</td><td className="px-3 py-3">File in memoria, non salvati</td></tr>
          ...
          <h2>Markdown Free</h2>
          <p>Convertitore Markdown basato su browser: gli export HTML, TXT, immagine (PNG/JPG), EPUB ed Excel vengono elaborati interamente nel browser, mentre PDF e Word (DOCX) sono generati su infrastruttura serverless con file in memoria, scartati immediatamente. Costruito sul principio che aggiungere registrazioni, pubblicità o tracker rovini un&apos;attività che dovrebbe durare 30 secondi.</p>
          ...
          <p><strong>Punti di forza:</strong> nessuna registrazione, nessun cookie di tracciamento, analytics rispettoso della privacy, UI in 10 lingue, output DOCX solido per chi converte Markdown generato da AI in documenti Word aziendali, formule LaTeX e diagrammi Mermaid renderizzati in ogni formato.<br /><strong>Limiti:</strong> tetto di 1MB per file in input, nessuna modalità offline (richiede browser), nessun batch (un file alla volta), nessuna personalizzazione dello stile PDF, formule in Word non ancora modificabili.<br /><strong>Ideale per:</strong> chi deve convertire Markdown in PDF, DOCX o EPUB ora senza installare nulla, specialmente con script non latini.</p>
