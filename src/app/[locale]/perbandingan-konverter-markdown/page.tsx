...
const faq = [
  ...
  { q: "Konverter Markdown mana yang paling aman untuk dokumen sensitif?", a: "Apa pun yang berjalan secara lokal — Pandoc, Typora, Markdown PDF (VS Code), md-to-pdf — menyimpan file Anda tetap di mesin Anda. Di antara alat browser, Markdown Free memproses ekspor HTML, TXT, gambar, EPUB, dan Excel sepenuhnya di browser, serta PDF dan dokumen Word di memori serverless tanpa menyimpannya. Alat yang mengunggah ke server (Online2PDF) memiliki risiko privasi paling tinggi." },
  { q: "Apakah Markdown Free punya batas ukuran file?", a: "Ada — saat ini 1MB per file. Markdown 1MB setara sekitar 150.000 kata, mencakup hampir semua dokumen nyata. Untuk file lebih besar, Pandoc dari command line tidak punya batas ukuran bawaan." },
];
    ...
    <ConverterProvider>
      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-8 px-4 pb-16 pt-10">
        <article className="prose prose-slate max-w-none">
          ...
          <h2>Markdown Free</h2>
          <p>Konverter Markdown berbasis browser: ekspor HTML, TXT, gambar (PNG/JPG), EPUB, dan Excel berjalan sepenuhnya di browser, sedangkan PDF dan Word (DOCX) dibuat di infrastruktur serverless dengan file diproses di memori dan langsung dibuang. Dibangun atas prinsip bahwa menambahkan pendaftaran, iklan, atau tracker membuat tugas 30 detik jadi menyebalkan.</p>
          ...
          <p><strong>Kelebihan:</strong> tanpa pendaftaran, tanpa cookie pelacak, analitik ramah privasi, UI 10 bahasa, output DOCX kuat untuk mengonversi Markdown buatan AI ke dokumen Word korporat, rumus LaTeX dan diagram Mermaid dirender di semua format.<br /><strong>Kekurangan:</strong> batas 1MB per file, tanpa mode offline (butuh browser), tanpa batch (satu file per kali), tidak bisa menyesuaikan gaya PDF, rumus di Word belum bisa diedit.<br /><strong>Cocok untuk:</strong> siapa saja yang perlu mengonversi Markdown ke PDF, DOCX, atau EPUB sekarang juga tanpa instalasi, terutama untuk skrip non-Latin.</p>
