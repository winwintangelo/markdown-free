...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: "/vi/so-sanh-cong-cu-markdown" },
        ...
        <article className="prose prose-slate max-w-none">
          ...
          <div className="not-prose my-6 overflow-x-auto"><table className="w-full border-collapse text-sm">
            ...
            <tbody className="text-slate-700">
              <tr className="border-b border-slate-100"><td className="px-3 py-3 font-medium">Markdown Free</td><td className="px-3 py-3">Trình duyệt, chữ viết phi-Latin</td><td className="px-3 py-3">Miễn phí</td><td className="px-3 py-3">Có — font Noto được nhúng, không cần thiết lập</td><td className="px-3 py-3">PDF, DOCX, EPUB, HTML, TXT</td><td className="px-3 py-3">Không có</td><td className="px-3 py-3">Tệp trong bộ nhớ, không lưu trữ</td></tr>
