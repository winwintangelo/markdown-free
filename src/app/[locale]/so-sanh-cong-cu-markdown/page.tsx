...
const faq = [
  ...
  { q: "Công cụ chuyển đổi Markdown nào an toàn nhất cho tài liệu nhạy cảm?", a: "Bất kỳ công cụ nào chạy cục bộ — Pandoc, Typora, Markdown PDF (VS Code), md-to-pdf — đều giữ tệp của bạn trên máy của bạn. Trong số các công cụ trình duyệt, Markdown Free xử lý các bản xuất HTML, TXT, hình ảnh, EPUB và Excel hoàn toàn trong trình duyệt, còn PDF và tài liệu Word được xử lý trong bộ nhớ serverless mà không lưu trữ. Các công cụ tải lên server (Online2PDF) có rủi ro riêng tư cao nhất." },
  { q: "Markdown Free có giới hạn kích thước tệp không?", a: "Có — hiện tại 1MB mỗi tệp. 1MB Markdown tương đương khoảng 150.000 từ, bao gồm gần như tất cả tài liệu thực. Đối với tệp lớn hơn, Pandoc từ command line không có giới hạn kích thước tích hợp." },
];
    ...
    <ConverterProvider>
      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-8 px-4 pb-16 pt-10">
        <article className="prose prose-slate max-w-none">
          ...
          <h2>Markdown Free</h2>
          <p>Trình chuyển đổi Markdown trên trình duyệt: các bản xuất HTML, TXT, hình ảnh (PNG/JPG), EPUB và Excel chạy hoàn toàn trong trình duyệt, còn PDF và Word (DOCX) được tạo trên hạ tầng serverless với tệp được xử lý trong bộ nhớ và bị loại bỏ ngay lập tức. Được xây dựng trên nguyên tắc rằng việc thêm đăng ký, quảng cáo hoặc trình theo dõi sẽ làm tác vụ 30 giây trở nên khó chịu.</p>
          ...
          <p><strong>Ưu điểm:</strong> không đăng ký, không cookie theo dõi, phân tích thân thiện với riêng tư, UI 10 ngôn ngữ, đầu ra DOCX mạnh để chuyển đổi Markdown do AI tạo ra thành tài liệu Word doanh nghiệp, công thức LaTeX và sơ đồ Mermaid được hiển thị ở mọi định dạng.<br /><strong>Nhược điểm:</strong> giới hạn 1MB mỗi tệp, không có chế độ ngoại tuyến (cần trình duyệt), không hàng loạt (mỗi lần một tệp), không thể tùy chỉnh kiểu PDF, công thức trong Word chưa chỉnh sửa được.<br /><strong>Phù hợp với:</strong> bất kỳ ai cần chuyển đổi Markdown sang PDF, DOCX hoặc EPUB ngay bây giờ mà không cần cài đặt, đặc biệt cho chữ viết phi-Latin.</p>
