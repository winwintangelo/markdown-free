...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: "/zh-Hans/markdown-zhuanhuanqi-bijiao" },
    openGraph: { title: "Markdown 转 PDF 工具对比 2026", description: "诚实对比 8 款 Markdown 转 PDF 工具，按用途说明哪款适合你。", locale: "zh_CN" },
  };
}
          ...
          <div className="not-prose my-6 overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-slate-700">
                <tr className="border-b border-slate-100"><td className="px-3 py-3 font-medium">Markdown Free</td><td className="px-3 py-3">浏览器，中文不乱码</td><td className="px-3 py-3">免费</td><td className="px-3 py-3">完全支持・嵌入 Noto 字体・无需配置</td><td className="px-3 py-3">PDF, DOCX, EPUB, HTML, TXT</td><td className="px-3 py-3">无</td><td className="px-3 py-3">内存处理，不存储</td></tr>
