          ...
          <div className="not-prose my-6 overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-slate-700">
                <tr className="border-b border-slate-100"><td className="px-3 py-3 font-medium">Markdown Free</td><td className="px-3 py-3">브라우저, 한글 그대로</td><td className="px-3 py-3">무료</td><td className="px-3 py-3">완벽 지원 ・ Noto 폰트 임베드 ・ 설정 불필요</td><td className="px-3 py-3">PDF, DOCX, PNG, EPUB, HTML, TXT</td><td className="px-3 py-3">없음</td><td className="px-3 py-3">메모리에서 처리, 저장 안 함</td></tr>
