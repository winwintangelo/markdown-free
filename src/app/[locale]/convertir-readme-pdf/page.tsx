...
const faq = [
  ...
  { q: "¿Puedo convertir README.md a PDF sin registrarme?", a: "Sí. Markdown Free no requiere cuenta. Los archivos se procesan en tu navegador (HTML/TXT/EPUB) o en memoria serverless (PDF/DOCX) y nunca se almacenan." },
